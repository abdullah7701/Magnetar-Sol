    ...
    <div className="mt-40 px-20 grid grid-cols-2 gap-10">
      <div>
        ...
        <Animation className="leading-tight mt-6 font-semibold" delay={0.5}>
          <Text div>
            We craft intuitive user interfaces that engage and delight users.
          </Text>
          <Text div>
            Our designs prioritize usability and creativity, ensuring exceptional user experiences.
          </Text>
          <Text div>Let’s build your next user-centered interface.</Text>
        </Animation>
      </div>
...
const UIDesignProcess = ({ data, index }) => {
  return (
...
const UIDesignProcessSelector = ({ data, index, onClick, isSelected }) => {
  return (
    <div
  ...
  return (
    <div className="mx-20 mt-20">
      ...
      <Animation>
        <div className="flex mt-10">
          ...
          <div className="w-1/2 mt-20 ml-40">
            ...
            >
              {processes.map((process, index) => (
                <UIDesignProcess data={process} index={index} key={index} />
              ))}
            </Slider>
          </div>
        </div>
      ...
      <Animation className="text-4xl font-semibold leading-tight mt-32">
        <Text underlined>Crafting Interfaces</Text>
        <Text> with</Text>
        <Text div className="!text-mid">
